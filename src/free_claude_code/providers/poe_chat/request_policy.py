...
def build_poe_chat_request_body(
    request_data: MessagesRequest,
    *,
    reasoning: ReasoningPolicy,
    policy: PoeChatRequestPolicy,
...
def apply_poe_chat_body_policy(
    body: dict[str, Any], policy: PoeChatRequestPolicy
) -> None:
