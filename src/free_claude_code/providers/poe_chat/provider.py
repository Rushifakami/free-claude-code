...
from .behavior import PoeChatBehavior
from .client import PoeAsyncCredentialProvider, create_chat_client
from .profiles import PoeChatProfile
from .transport import PoeChatTransport


class PoeChatProvider(BaseProvider):
    ...
    def __init__(
        ...
        *,
        profile: PoeChatProfile | None = None,
        behavior: PoeChatBehavior | None = None,
        admission: ProviderAdmissionController,
        default_headers: Mapping[str, str] | None = None,
        api_key_provider: PoeAsyncCredentialProvider | None = None,
        ...
        if behavior is None:
            ...
            behavior = PoeChatBehavior(profile)
